...
def check_environment():
    ...
    if missing_vars:
        ...
        print("\nOptional webhooks:")
        print("TICKET_WEBHOOK=your_ticket_webhook_url")
        print("MONEYLINE_WEBHOOK=your_moneyline_webhook_url")
        print("UPDATE_WEBHOOK=your_update_webhook_url")
        return False
    ...
    if missing_optional:
        print("⚠️ Missing optional webhooks (will use fallbacks):")
